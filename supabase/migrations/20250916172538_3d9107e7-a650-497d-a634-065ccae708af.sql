...
INSERT INTO emission_factors (name, category, activity_unit, co2_factor, ch4_factor, n2o_factor, source, year_of_validity, type, created_at) VALUES

-- Stationary Combustion - Additional factors
('Óleo Combustível 1A', 'Combustão Estacionária', 't', 77.4, 3.0, 0.6, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Óleo Combustível 2A', 'Combustão Estacionária', 't', 77.4, 3.0, 0.6, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Óleo Combustível 3A', 'Combustão Estacionária', 't', 77.4, 3.0, 0.6, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Querosene Iluminante', 'Combustão Estacionária', 'L', 2.52, 3.0, 0.6, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),

-- Mobile Combustion - Additional factors
('Gasolina Automotiva', 'Combustão Móvel', 'L', 2.2718, 0.25, 0.02, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Óleo Diesel S10', 'Combustão Móvel', 'L', 2.6071, 0.04, 0.19, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Óleo Diesel S500', 'Combustão Móvel', 'L', 2.6071, 0.04, 0.19, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),

-- Fugitive Emissions - Additional sources
('Vazamento de Gás Natural', 'Emissões Fugitivas', 'm³', 1.99, 21.0, 0.01, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Ventilação de Gás Natural', 'Emissões Fugitivas', 'm³', 1.99, 21.0, 0.01, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),

-- Waste Treatment
('Tratamento de Efluentes - Aeróbio', 'Tratamento de Efluentes', 'kg DBO', 0.0, 0.0, 0.0057, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Tratamento de Efluentes - Anaeróbio', 'Tratamento de Efluentes', 'kg DBO', 0.0, 0.25, 0.0, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),

-- Industrial Processes
('Produção de Cimento - Calcário', 'Processos Industriais', 't calcário', 440.0, 0.0, 0.0, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Produção de Cal', 'Processos Industriais', 't cal', 785.0, 0.0, 0.0, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW()),
('Produção de Aço - Alto Forno', 'Processos Industriais', 't aço', 1670.0, 0.0, 0.0, 'GHG Protocol Brasil 2025.0.1', 2024, 'system', NOW())
