...
INSERT INTO variable_factors (year, month, biodiesel_percentage, ethanol_percentage, electricity_factor_sin, created_at, updated_at) VALUES
...
ON CONFLICT (year, month) DO UPDATE SET 
  ...
  electricity_factor_sin = EXCLUDED.electricity_factor_sin,
  updated_at = NOW();
...
-- Add some key missing emission factors from standard GHG Protocol Brasil categories
