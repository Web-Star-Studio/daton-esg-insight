-- EXPANSÃO CRÍTICA DA BIBLIOTECA DE FATORES - FASE 2
-- Adicionar fatores essenciais identificados como faltantes

-- 1. GASES REFRIGERANTES (GWP altíssimo - crítico para inventários)
...
-- 2. COMBUSTÍVEIS FALTANTES ESSENCIAIS
...
-- 3. PROCESSOS INDUSTRIAIS BÁSICOS  
...
-- 6. ATUALIZAR METADADOS DOS GASES REFRIGERANTES COM GWP CORRETO
...
-- 7. ADICIONAR CAMPOS DE RASTREABILIDADE (FASE 3 PARCIAL)
