...
-- Remover policy permissiva para companies e criar policy mais restritiva
DROP POLICY IF EXISTS "Allow company creation during registration" ON public.companies;

-- Apenas usuários autenticados podem ver sua empresa
...
-- Apenas usuários autenticados podem atualizar sua empresa
