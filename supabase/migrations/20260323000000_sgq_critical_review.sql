-- Adds "análise crítica" step between elaborator and approver in SGQ document workflow.
-- The critical reviewer must approve before the designated approver can approve.
...
-- Expand audit_notifications constraint to include the new critical review notification type
