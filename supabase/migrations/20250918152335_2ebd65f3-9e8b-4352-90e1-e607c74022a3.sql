-- Verificar e criar apenas o que está faltando

-- Inserir temas de materialidade (se não existirem)
...
-- Função para auto-configurar steps de uma avaliação (se não existir)
