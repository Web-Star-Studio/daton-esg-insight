...
interface AddCustomFactorModalProps {
  open: boolean
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">
            Adicionar Fator de Emissão Customizado
          </DialogTitle>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Card className="bg-muted/50">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  O fator em tCO₂e será calculado automaticamente com base nos Potenciais de Aquecimento Global (GWP) do IPCC ao salvar.
                </p>
              </CardContent>
            </Card>
