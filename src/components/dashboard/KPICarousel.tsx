...
import { ChevronLeft, ChevronRight, Zap, Leaf, Users, Shield, Award, MoreVertical } from 'lucide-react';
    ...
    <div className="relative" data-tour="metrics">
      ...
      <div className="absolute -left-3 top-1/2 -translate-y-1/2 z-10">
        <Button
          ...
          size="icon"
          className={cn(
            "h-8 w-8 rounded-full bg-background shadow-md border-border/50 transition-all",
