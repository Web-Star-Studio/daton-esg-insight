...
export function AddEmissionSourceModal({ open, onOpenChange }: AddEmissionSourceModalProps) {
  ...
  const watchedTipoCombustivel = form2.watch("tipoCombustivel")
  ...
  const onStep1Submit = (data: Step1Data) => {
    ...
    // Se for Escopo 1 e Combustão Estacionária, ir para passo 2
  ...
  const handleFinalSubmit = (step1: Step1Data, step2: Step2Data | null) => {
    console.log("Dados finais:", { step1, step2 })
