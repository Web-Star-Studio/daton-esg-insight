    ...
    Tables: {
      ...
      accounting_entry_lines: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "accounting_entry_lines_cost_center_id_fkey"
      ...
      chart_of_accounts: {
        Row: {
          accepts_cost_center: boolean | null
          accepts_project: boolean | null
          account_code: string
          account_name: string
      ...
      gri_economic_data_collection: {
        Row: {
          ...
          ai_confidence_score: number | null
          ai_generated_text: string | null
          asset_sales_income: number | null
          ...
          completion_percentage: number | null
          created_at: string | null
          ded_growth_percentage: number | null
          deg_growth_percentage: number | null
          direct_economic_value_distributed: number | null
          direct_economic_value_generated: number | null
          dividends_paid: number | null
          ebitda: number | null
          ebitda_margin: number | null
          economic_value_retained: number | null
          employee_benefits: number | null
          employee_salaries: number | null
          ...
          gri_201_1_complete_compliant: boolean | null
          gri_201_1_compliant: boolean | null
          gri_201_1_missing_fields: Json | null
          ...
          infrastructure_investments: number | null
          ...
          other_operational_costs: number | null
          other_taxes: number | null
          payroll_taxes: number | null
          previous_period_ded: number | null
          previous_period_deg: number | null
          previous_period_sustainable_investment: number | null
          previous_period_sustainable_revenue: number | null
          previous_period_ver: number | null
          raw_materials_costs: number | null
          report_id: string
          reporting_period_end: string | null
          reporting_period_start: string | null
          ...
          stakeholder_value_per_type: Json | null
          ...
          total_capital_providers_payments: number | null
          total_community_investments: number | null
          total_employee_compensation: number | null
          total_government_payments: number | null
          total_operational_costs: number | null
          total_suppliers_count: number | null
          total_sustainable_investment: number | null
          updated_at: string | null
          value_distribution_breakdown: Json | null
          value_distribution_calculation_date: string | null
          value_distribution_data_source: string | null
          value_distribution_percentage: Json | null
          ver_growth_percentage: number | null
          voluntary_donations: number | null
        }
        Insert: {
          active_sustainable_projects?: number | null
          ai_analysis?: Json | null
      ...
      gri_governance_data_collection: {
        Row: {
          ...
          wb_calculation_date: string | null
          wb_change_percentage: number | null
          ...
          wb_open_reports: number | null
          wb_performance_classification: string | null
          wb_previous_period_total: number | null
          wb_previous_resolution_rate: number | null
          wb_reports_30_90_days: number | null
      ...
      payment_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "payment_history_bank_account_id_fkey"
            columns: ["bank_account_id"]
            isOneToOne: false
            referencedRelation: "bank_accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "payment_history_payable_id_fkey"
            columns: ["payable_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "payment_history_receivable_id_fkey"
      ...
      supplier_document_evaluations: {
        Row: {
          ...
          total_weight_achieved: number | null
          total_weight_required: number | null
        }
        Insert: {
          company_id: string
          compliance_percentage?: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "supplier_document_evaluations_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "supplier_document_evaluations_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "supplier_management"
            referencedColumns: ["id"]
      ...
      supplier_expiration_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "supplier_expiration_alerts_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "supplier_expiration_alerts_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "supplier_management"
            referencedColumns: ["id"]
      ...
      supplier_performance_evaluations: {
        ...
        Relationships: [
          {
            foreignKeyName: "supplier_performance_evaluations_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "supplier_performance_evaluations_product_service_id_fkey"
            columns: ["product_service_id"]
            isOneToOne: false
            referencedRelation: "supplier_products_services"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "supplier_performance_evaluations_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "supplier_management"
            referencedColumns: ["id"]
      ...
      supplier_products_services: {
        ...
        Relationships: [
          {
            foreignKeyName: "supplier_products_services_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "supplier_products_services_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "supplier_management"
            referencedColumns: ["id"]
      ...
      training_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "training_categories_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
