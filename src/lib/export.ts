...
export const SECTION_ROUTES: Record<string, string> = {
  ...
  'license-alerts': '/licenciamento/processar',
  'license-ai-analysis': '/licenciamento/processar',
  'document-extraction-jobs': '/licenciamento/processar',
  'extracted-data': '/licenciamento/processar',
  'extractions': '/licenciamento/processar',
  'extraction-items-staging': '/licenciamento/processar',
  'extraction-items-curated': '/licenciamento/processar',
